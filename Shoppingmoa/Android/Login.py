        ...
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                try:
                    ...
                    pass
                self.interact_by_xpath('//android.view.View[@content-desc="마이쇼핑"]/android.view.View', search_sec=20) # 마이쇼핑 클릭
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
        ...
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                try:
                    ...
                    pass
                self.interact_by_xpath('//android.view.View[@content-desc="카테고리"]', search_sec=20, wait_sec=10) # 카테고리 버튼 클릭
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
        ...
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                try:
                    ...
                    pass
                self.interact_by_xpath('//*[contains(@content-desc, "장바구니")]', search_sec=200) # 장바구니 클릭
                self.interact_by_xpath('//android.view.View[@content-desc="로그인"]/android.widget.TextView', search_sec=20) # 로그인 클릭
                self.interact_by_xpath('(//android.widget.EditText)[1]', search_sec=20, send_keys_msg="testbuzzni@gmail.com", click=False) # 아이디 입력
                self.interact_by_xpath('(//android.widget.EditText)[2]', search_sec=20, send_keys_msg="choppa2017!", click=False) # 비밀번호 입력
                self.interact_by_xpath('//android.widget.Button[@text="로그인"]', search_sec=20) # 로그인 버튼 클릭
                ...
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(2)
                self.interact_by_xpath('//android.view.View[@content-desc="로그아웃 로그아웃"]/android.widget.TextView', search_sec=20) # 로그아웃 버튼 클릭
            except:
                # if loop_count == (TCFG.check_loop_count-1):
                if loop_count == 0:
                    print("Error!")
    ...
    def test_11_GS_MY_SHOP(self):
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                sleep(2)
                try:
                    self.interact_by_xpath('//android.widget.Button[@text="7일간 안보기"]', search_sec=10) # 7일간 안보기 클릭
                except:
                    pass
                self.interact_by_xpath('//android.view.View[@content-desc="마이쇼핑"]/android.view.View', search_sec=20) # 마이쇼핑 클릭
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                ...
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
                TouchAction(TCFG.driver).tap(None, 354, 1546, 1).perform() # 로그아웃 버튼 클릭
                sleep(2)
                self.interact_by_xpath('//android.widget.Button[@text="확인"]', search_sec=20) # 확인 클릭
            except:
                # if loop_count == (TCFG.check_loop_count-1):
    ...
    def test_12_Shopping_and_T(self):
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                self.interact_by_xpath('(//android.widget.EditText)[2]', search_sec=20, send_keys_msg="choppa2017!", click=False) # 비밀번호 입력
                self.interact_by_xpath('//android.view.View[@content-desc="로그인"]', search_sec=20) # 로그인 버튼 클릭
                self.interact_by_xpath('//android.view.View[@content-desc="홈으로 바로가기"]', search_sec=20) # 홈으로 바로가기 클릭
                try:
                    self.interact_by_xpath('//android.view.View[@content-desc="모바일 웹에서 계속 쇼핑하기"]', search_sec=20) # 모바일 웹에서 계속 쇼핑하기 클릭
                except:
                    pass
                self.interact_by_xpath('//android.view.View[@content-desc="마이쇼핑"]', search_sec=20) # 마이쇼핑 클릭
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
    ...
    def test_15_KT_Alpha_Shopping_TVPlus(self):
        for loop_count in range(0, TCFG.check_loop_count):
            try:
                ...
                self.interact_by_xpath('(//android.widget.EditText)[2]', search_sec=20, send_keys_msg="choppa2017!", click=False) # 비밀번호 입력
                self.interact_by_xpath('//android.widget.Button[@text="로그인"]', search_sec=20) # 로그인 버튼 클릭
                self.interact_by_xpath('//android.view.View[@content-desc="상품 둘러보기"]', search_sec=20) # 상품 둘러보기 클릭
                try:
                    self.interact_by_xpath('//android.widget.Button[@text="다음에 동의할게요"]', search_sec=5) # 다음에 동의할게요 클릭
                    self.interact_by_xpath('//android.widget.Button[@text="확인"]', search_sec=20) # 확인 클릭
                except:
                    pass
                self.interact_by_xpath('//android.view.View[@content-desc="카테고리"]', search_sec=20) # 카테고리 버튼 클릭
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
                TCFG.driver.swipe(217, 1660, 217, 200, 10)
                sleep(3)
                self.interact_by_xpath('//*[contains(@content-desc, "로그아웃")]', search_sec=20) # 로그아웃 버튼 클릭
            except:
                # if loop_count == (TCFG.check_loop_count-1):
                if loop_count == 0:
                    print("Error!")
